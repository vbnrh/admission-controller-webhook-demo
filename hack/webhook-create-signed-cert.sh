...
echo "Inside webhook-create-signed-cert"

[ -z ${service} ] && service=okd-admission-controller-service
[ -z ${secret} ] && secret=okd-admission-controller-secret
...
echo "Exiting webhook-create-signed-cert"
